...
class TestArgmax(TestCase):
    def test_simple(self):
        ...
        # create an array in the data sections
        array0 = t.array([1, -2, 3, -4, 5, 13, -6, 7, 9])
...
class TestDot(TestCase):
    def test_simple(self):
        ...
        array0 = t.array([1, -2, 3, -4, 5, 13, -6, 7, 9])
        array1 = t.array([1, -2, 3, -4, 5, 13, -6, 7, 9])
...
class TestReadMatrix(TestCase):
    ...
    def test_simple(self):
        self.do_read_matrix() # add attributes to confirm error testing
...
class TestWriteMatrix(TestCase):
    ...
    def test_simple(self):
        self.do_write_matrix() # to be added...
